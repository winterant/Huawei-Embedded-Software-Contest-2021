...
class Config:
    ...
    # CASE_FOLDER_NAME = "cases"
    CASE_FOLDER_NAME = "cases25"
    # CASE_NAME_VEC = [
    #     "Example",
    #     "TestData_24",
    # ]
    CASE_NAME_VEC = [os.path.splitext(os.path.basename(f))[0] for f in os.listdir(CASE_FOLDER_NAME) if os.path.basename(f).endswith('.case')]
